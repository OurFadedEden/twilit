...
const SEED = {
  site: {
    ...
    /* 대문 암호 — 비우면 누구나 입장.
       주의: 이 값은 파일에 그대로 들어가므로 소스를 보면 읽힙니다.
       보안이 아니라 "아는 사람만 들어오는" 연출용입니다. */
    gatePwd: "",
    ...
    /* 부팅 로그 — 문구 | 결과 | 색(ok=심해색, hit=황혼색, 비우면 회색)
       {RECORDS} 는 블록 개수로 자동 치환됩니다. */
    bootLines: [
      "SONAR ARRAY ................ | ONLINE | ok",
      "PRESSURE HULL .............. | NOMINAL | ok",
      "OUTBOUND TRANSMITTER ....... | DISABLED | hit",
      "ARCHIVE CH.34.12 ........... | {RECORDS} RECORDS FOUND | ok",
      "",
      "채널 대기 중."
    ],
  ...
  logs: [
    {
      ...
      /* 프로필 헤더 — 비우면 안 나옵니다 */
      banner: "", avatar: "",
      pfName: "이름", handle: "@username",
      bio: "여기에 한 줄 소개를 적어주세요.",

      /* 태그 칩 — 앞에 ! 를 붙이면 황혼색 강조 */
      tags: ["잔잔한 서사", "형제물", "!캐붕 주의"],
