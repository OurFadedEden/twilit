...
const SEED = {
  site: {
    ...
    strata: [
      { name: "EPIPELAGIC · 표층", desc: "빛이 닿는다. 아직은 아무 말이나 해도 되는 깊이." },
      { name: "MESOPELAGIC · 박광층", desc: "황혼이 시작되는 층. 색이 하나씩 사라진다." },
      { name: "BATHYPELAGIC · 무광층", desc: "빛이 완전히 끊긴다. 남는 건 압력과 목소리뿐." }
    ],

    /* ── 방명록 (giscus) ──
       깃허브 저장소에 Discussions를 켜고 giscus.app 에서
       발급받은 값을 넣으면 방명록이 켜집니다. 비우면 숨겨집니다. */
  ...
  logs: [
    {
      id: 1, type: "list", depth: "-120M", time: "18:47:02",
      title: "트위터 성향표",
    ...
    {
      id: 2, type: "profile", depth: "-880M", time: "19:22:14",
      title: "형 — 황혼",
    ...
    {
      id: 3, type: "profile", depth: "-1,450M", time: "20:13:58",
      title: "동생 — 심해",
    ...
    {
      id: 4, type: "dialogue", depth: "-2,100M", time: "01:07:33",
      title: "마지막 교신",
    ...
    {
      id: 5, type: "friends", depth: "-2,400M", time: "02:55:10",
      title: "동행 신호",
    ...
    {
      id: 6, type: "links", depth: "-2,800M", time: "03:41:—",
      title: "바깥으로",
